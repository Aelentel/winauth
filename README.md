...
## WinAuth 3.5.2 (latest stable)

WinAuth provides an alternative solution to combine various two-factor authenticator services in one convenient place.

[Latest Version (WinAuth-3.5.2)](https://www.uplinklabs.net/projects/winauth/downloads/WinAuth-3.5.2.zip)
...
##### Release 3.5.2
  * Fixed URI encoding for import/export feature
  * Added HMAC-SHA256 and HMAC-SHA512
...
WinAuth was written by Colin Mackie. Copyright (C) 2010-2016. Bitcoin donations can be sent to `1C4bMkMATViiWYsmJSDUx2MruWM785C36Y`

Currently maintained by Steven Noonan. Copyright (C) 2017.
